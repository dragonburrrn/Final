...
m_DZ = Menu("ДЗ", buttons=["Задание-1", "Задание-2", "Задание-3", "Задание-4", "Задание-5", "Задание-6","Задание-7","Задание-8", "Выход"], parent=m_main)

m_fun = Menu("Развлечения", buttons=["Прислать аниме", "Прислать анекдот", "Прислать фильм", "Wikipedia","Выход"], parent=m_main)