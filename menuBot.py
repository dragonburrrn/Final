...
m_games = Menu("Игры", buttons=["Игра КНБ", "Игра КНБ-MP", "Игра в 21",  "Города", "Выход"], parent=m_main)
...
m_game_c = Menu("Города", buttons=["Выход"], parent=m_games, module="BotGames")

m_DZ = Menu("ДЗ", buttons=["Задание-1", "Задание-2", "Задание-3", "Задание-4", "Задание-5", "Задание-6", "Задание-7", "Задание-8", "Выход"], parent=m_main, module="DZ")

m_fun = Menu("Развлечения", buttons=["Прислать аниме", "Прислать анекдот",  "Wikipedia", "Прислать фильм", "Выход"], parent=m_main, module="fun")
